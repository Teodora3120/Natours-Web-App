...
})(
  {
      ...
      function (require, module, exports) {
        ...
        const H = (e, t, r, { allOwnKeys: o } = {}) => (
            E(
              t,
              (t, o) => {
                r && m(t) ? (e[o] = (0, n.default)(t, r)) : (e[o] = t);
              },
              { allOwnKeys: o },
            ),
            e
          ...
          oe = {
            DIGIT: ne,
            ALPHA: re,
            ALPHA_DIGIT: re + re.toUpperCase() + ne,
          },
        ...
        const ae = (e) => {
          ...
          le = l('AsyncFunction'),
          ce = (e) => e && (h(e) || m(e)) && m(e.then) && m(e.catch),
          ue = ((e, t) =>
            e
              ? setImmediate
              : t
                ? ((e, t) => (
                    R.addEventListener(
                      'message',
                      ({ source: r, data: n }) => {
                        r === R && n === e && t.length && t.shift()();
                      },
                      !1,
                    ),
                    (r) => {
                      t.push(r), R.postMessage(e, '*');
                    }
                  ))(`axios@${Math.random()}`, [])
                : (e) => setTimeout(e))(
        ...
        var R = (exports.default =
          ...
          (async (e) => {
            ...
            try {
              ...
              if (
                (j && j(),
                P && 'TypeError' === P.name && /fetch/i.test(P.message))
              )
                throw Object.assign(
    ...
    RB6n: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.default = void 0);
        var e = l(require('./../utils.js')),
          t = l(require('../helpers/buildURL.js')),
          r = l(require('./InterceptorManager.js')),
          a = l(require('./dispatchRequest.js')),
          s = l(require('./mergeConfig.js')),
          n = l(require('./buildFullPath.js')),
          o = l(require('../helpers/validator.js')),
          i = l(require('./AxiosHeaders.js'));
        function l(e) {
          return e && e.__esModule ? e : { default: e };
        }
        const u = o.default.validators;
        class c {
          constructor(e) {
            (this.defaults = e),
              (this.interceptors = {
          ...
          _request(t, r) {
            ...
            const { transitional: n, paramsSerializer: l, headers: c } = r;
            void 0 !== n &&
              o.default.assertOptions(
                n,
                {
          ...
          getUri(e) {
            ...
            const r = (0, n.default)(e.baseURL, e.url);
    ...
    BCHI: [
      function (require, module, exports) {
        ...
        var u = (exports.signup = (function () {
          var e = a(
            o().mark(function e(n, i, a, u, c) {
              var s;
              return o().wrap(
                function (e) {
                  for (;;)
      ...
      function (require, module, exports) {
        ...
        var e = (exports.displayMap = function (e) {
          mapboxgl.accessToken =
            'pk.eyJ1IjoidGVvZG9yYTMxMDMiLCJhIjoiY203YWsyOG1jMDRhNjJqc2R0c21nOHVkcSJ9.GWkjLITJeDZYvK3BX4Up0g';
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (e.prev = 0),
                            (i = '/api/v1/bookings/checkout-session/'.concat(
                              n,
                            )),
                            (e.next = 4),
                            t.default.get(i)
      ...
      function (require, module, exports) {
        ...
        function i() {
          ...
          function k(e, r) {
            function t(o, n, i, c) {
              ...
              if ('throw' !== a.type) {
                var l = a.arg,
                  d = l.value;
                return d && 'object' == u(d) && s.call(d, '__await')
          ...
          function N(r) {
            ...
            throw new TypeError(u(r) + ' is not iterable');
          }
          return (
            (v.prototype = b),
        ...
        var l = document.getElementById('map'),
          d = document.querySelector('.form'),
          m = document.querySelector('#signup-form'),
          ...
          h = document.getElementById('book-tour');
        if (l) {
          var y = JSON.parse(l.dataset.locations);
          (0, t.displayMap)(y);
        }
        d &&
          d.addEventListener('submit', function (r) {
            r.preventDefault();
            var t = document.getElementById('login-email').value,
              s = document.getElementById('login-password').value;
            (0, e.login)(t, s);
          }),
          m &&
            m.addEventListener('submit', function (e) {
              e.preventDefault();
              var t = document.getElementById('signup-name').value,
                s = document.getElementById('signup-email').value,
                o = document.getElementById('signup-password').value,
                n = document.getElementById('signup-passwordConfirm').value,
                u = document.getElementById('role').value;
              (0, r.signup)(t, s, o, n, u);
            }),
          j && j.addEventListener('click', e.logout),
          f &&
            f.addEventListener('submit', function (e) {
              e.preventDefault();
              var r = new FormData();
              r.append('name', document.getElementById('settings-name').value),
                r.append(
                  'email',
          ...
          h &&
            h.addEventListener('click', function (e) {
              e.preventDefault(), (e.target.textContent = 'Processing...');
              var r = e.target.dataset.tourId;
              (0, o.bookTour)(r);
            });
        var g = document.querySelector('body').dataset.alert;
        g && (0, n.showAlert)('success', g, 20);
      },
      {
