...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGVvZG9yYTMxMDMiLCJhIjoiY203YWsyOG1jMDRhNjJqc2R0c21nOHVkcSJ9.GWkjLITJeDZYvK3BX4Up0g';
    ...
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save-new-password').innerHTML = 'Updating ...';
          ...
          case 7:
            document.querySelector('.btn--save-new-password').innerHTML = 'Save password';
